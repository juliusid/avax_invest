      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-gray-900/50 p-3 rounded-lg border border-gray-700">
            ...
            <span className="text-lg font-bold text-farm-500">{project.roi}%</span>
          </div>
          <div className="bg-gray-900/50 p-3 rounded-lg border border-gray-700">
            <div className="flex items-center text-xs text-gray-400 mb-1">
              <Clock size={12} className="mr-1" /> Term
            </div>
            <span className="text-lg font-bold text-white">{project.termLength} <span className="text-xs font-normal text-gray-500">mos</span></span>
          </div>
        </div>
