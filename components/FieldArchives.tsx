      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="mb-16 flex flex-col md:flex-row justify-between items-end border-b border-gray-800 pb-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-lg text-gray-400 font-light leading-relaxed max-w-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 auto-rows-[300px] md:auto-rows-[350px]">
          ...
          <div className="group relative md:col-span-2 overflow-hidden bg-gray-800 border border-white/5 rounded-sm cursor-pointer">
            <img 
              src="https://images.unsplash.com/photo-1472214103451-9374bd1c7dd1?q=80&w=2070&auto=format&fit=crop" 
              alt="Aerial Survey" 
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-20 h-20 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center group-hover:bg-white/20 group-hover:scale-110 transition-all duration-500 border border-white/20">
                <Play className="w-8 h-8 text-white fill-current ml-1" />
              </div>
            </div>

            {/* Hover Info */}
            <div className="absolute bottom-0 left-0 p-8 w-full translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 bg-gradient-to-t from-black/80 to-transparent">
              <div className="flex justify-between items-end">
                <div>
                  <span className="block text-farm-400 text-[10px] tracking-[0.2em] uppercase mb-2 font-medium">Video Feed</span>
                  <h3 className="text-white text-2xl font-light">Aerial Survey: Iowa Belt</h3>
                </div>
                <div className="text-right text-gray-300 text-xs font-mono">
          ...
          <div className="group relative md:col-span-1 md:row-span-2 overflow-hidden bg-gray-800 border border-white/5 rounded-sm">
            <img 
            ...
            <div className="absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
               <div className="bg-black/60 backdrop-blur text-white border border-white/10 text-xs px-3 py-1 font-mono uppercase tracking-widest">
                  Harvest Day 12
               </div>
            </div>

            <div className="absolute bottom-0 left-0 p-8 w-full translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 bg-gradient-to-t from-black/80 to-transparent">
               <span className="block text-farm-400 text-[10px] tracking-[0.2em] uppercase mb-2 font-medium">Crop Report</span>
          ...
          <div className="group relative md:col-span-1 overflow-hidden bg-gray-800 border border-white/5 rounded-sm">
            <img 
            ...
            <div className="absolute bottom-0 left-0 p-8 w-full translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 bg-gradient-to-t from-black/80 to-transparent">
              <span className="block text-farm-400 text-[10px] tracking-[0.2em] uppercase mb-2 font-medium">Distribution</span>
          ...
          <div className="group relative md:col-span-1 overflow-hidden bg-gray-800 border border-white/5 rounded-sm">
            ...
            <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors duration-500" />
             ...
             <div className="absolute bottom-0 left-0 p-8 w-full translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 bg-gradient-to-t from-black/80 to-transparent">
              <span className="block text-farm-400 text-[10px] tracking-[0.2em] uppercase mb-2 font-medium">Community</span>
        ...
        <div className="mt-12 flex justify-center">
            <Link to="/archives">
              <button className="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors uppercase text-xs tracking-widest font-medium">
                  View Full Archive
