...
export const FieldArchives: React.FC = () => {
  return (
    <section id="archives" className="bg-gray-900 py-24 border-y border-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-[250px] md:auto-rows-[300px]">
          ...
          <div className="group relative md:col-span-1 md:row-span-2 overflow-hidden bg-gray-800 rounded-sm cursor-pointer">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6 bg-gradient-to-t from-gray-900 via-gray-900/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
               <span className="text-farm-400 text-xs tracking-widest uppercase font-bold mb-1">Harvest Report</span>
          ...
          <div className="group relative md:col-span-2 overflow-hidden bg-gray-800 rounded-sm cursor-pointer">
            ...
            />
            <div className="absolute inset-0 flex flex-col justify-end p-6 bg-gradient-to-t from-gray-900 via-gray-900/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
               <span className="text-farm-400 text-xs tracking-widest uppercase font-bold mb-1">Global Logistics</span>
               <h3 className="text-white text-2xl font-light">Supply Chain Loading</h3>
            </div>
          </div>
          ...
          <div className="group relative md:col-span-1 overflow-hidden bg-gray-800 rounded-sm cursor-pointer">
            ...
            />
            <div className="absolute inset-0 flex flex-col justify-end p-6 bg-gradient-to-t from-gray-900 via-gray-900/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
               <span className="text-farm-400 text-xs tracking-widest uppercase font-bold mb-1">Napa Valley</span>
               <h3 className="text-white text-2xl font-light">Vine Inspection</h3>
            </div>
          </div>
          ...
          <div className="group relative md:col-span-1 overflow-hidden bg-gray-800 rounded-sm cursor-pointer">
            ...
            />
            <div className="absolute inset-0 flex flex-col justify-end p-6 bg-gradient-to-t from-gray-900 via-gray-900/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
               <span className="text-farm-400 text-xs tracking-widest uppercase font-bold mb-1">Scotland</span>
