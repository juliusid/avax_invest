  ...
  const archiveItems = [
    {
      ...
      location: "42° N, 93° W",
      image:
        "https://images.unsplash.com/photo-1499529112071-48cb8a2e0100?auto=format&fit=crop&w=800&q=80",
      size: "wide",
      hasVideo: true,
    },
    {
      ...
      location: "Iowa, USA",
      image:
        "https://images.unsplash.com/photo-1551717366-2675d0506eb3?auto=format&fit=crop&w=800&q=80",
      size: "tall",
      description:
    ...
    },
    {
      ...
      location: "Kenya",
      image:
        "https://images.unsplash.com/photo-1595244585350-01d677864831?q=80&w=2672&auto=format&fit=crop",
      size: "standard",
    },
    {
      id: 5,
      ...
      location: "Napa, CA",
      image:
        "https://images.unsplash.com/photo-1526346698789-22fd84314424?auto=format&fit=crop&w=800&q=80",
      size: "standard",
    },
    {
      id: 6,
    ...
    // Extra items that show when expanded
    {
      ...
      location: "Midwest",
      image:
        "https://images.unsplash.com/photo-1625246333195-58197bd47d26?auto=format&fit=crop&w=1920&q=80",
      size: "standard",
    },
    {
      id: 8,
    ...
    },
    {
      ...
      location: "Sonora",
      image:
        "https://images.unsplash.com/photo-1563514227146-89309f80784d?auto=format&fit=crop&w=800&q=80",
      size: "standard",
    },
  ];
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <Link
            to="/"
            className="inline-flex items-center text-farm-500 font-medium mb-6 hover:text-white transition-colors"
          >
            &larr; Return Home
          </Link>
          <h1 className="text-4xl md:text-6xl font-light text-white mb-6 leading-tight font-serif tracking-tight">
            The Field{" "}
            <span className="text-farm-500 font-normal">Archives</span>
          </h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed font-light">
            A comprehensive chronological record of our agricultural operations,
            harvest reports, and technological audits from around the globe.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-24">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 border-b border-gray-800 pb-6">
          <div>
            <span className="text-farm-500 text-xs font-bold tracking-widest uppercase mb-2 block">
              Latest Entries
            </span>
          ...
          <div className="flex gap-4 mt-4 md:mt-0">
            ...
            <button className="text-sm text-gray-500 hover:text-white border-b border-transparent pb-1 hover:border-gray-500 transition-colors">
              Videos
            </button>
            <button className="text-sm text-gray-500 hover:text-white border-b border-transparent pb-1 hover:border-gray-500 transition-colors">
              Reports
            ...
            {archiveItems.map((item) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 p-6 w-full translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 bg-gradient-to-t from-black/80 to-transparent">
                  <span className="block text-farm-400 text-[10px] tracking-[0.2em] uppercase mb-1 font-medium">
                    {item.type}
                  </span>
            ...
            <div className="order-2 md:order-1 relative">
              ...
              <div className="absolute bottom-6 -right-6 bg-gray-800 p-4 rounded-lg border border-gray-700 shadow-xl max-w-xs hidden md:block">
                ...
                <p className="text-xs text-gray-400">
                  Our soil regeneration techniques have sequestered 12,000 tons
                  of CO2 this year.
                </p>
              </div>
            </div>
            <div className="order-1 md:order-2">
              <span className="text-farm-500 text-xs font-bold tracking-widest uppercase mb-4 block">
                Annual Report
              </span>
              ...
              <p className="text-gray-400 leading-relaxed mb-8">
                Beyond yields, we measure success by the health of our soil and
                the prosperity of our communities. Our latest audit reveals a
                40% reduction in water usage across our sub-Saharan projects and
                a complete transition to organic fertilizers in our Napa
                vineyards.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                We have deployed 500+ IoT sensors across our key assets to
                monitor soil moisture, acidity, and nutrient levels in
                real-time. This data-driven approach allows for precision
                farming that maximizes output while minimizing resource waste.
              </p>
